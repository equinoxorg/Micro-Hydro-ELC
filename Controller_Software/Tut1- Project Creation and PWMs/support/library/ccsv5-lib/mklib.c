/*---------------------------------------------------------------------------
 * This is mklib version 6.1.0 for C2000 compiler  
...
/*--------------------------------------------------------------------------- 
 * This source code is specific to compiler RTS library version 6.1.0.  
...
library_t LIBRARIES[] = {
    { "rts2700_ml_eh.lib", { "FULL_PORTABLE_EH","LARGE","C2700","EXCEPTIONS" } },
    { "rts2700_eh.lib", { "FULL_PORTABLE_EH","C2700","EXCEPTIONS" } },
    { "rts2800.lib", { "C2800" } },
    { "rts2700_ml.lib", { "LARGE","C2700" } },
    { "rts2800_ml.lib", { "LARGE","C2800" } },
    { "rts2800_eh.lib", { "FULL_PORTABLE_EH","EXCEPTIONS","C2800" } },
    { "rts2700.lib", { "C2700" } },
    { "rts2800_fpu32.lib", { "FPU32","C2800" } },
    { "rts2800_fpu32_eh.lib", { "FULL_PORTABLE_EH","FPU32","EXCEPTIONS","C2800" } },
    { "rts2800_ml_eh.lib", { "FULL_PORTABLE_EH","LARGE","EXCEPTIONS","C2800" } },
};
