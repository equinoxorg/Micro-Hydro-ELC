...
#include "..\header\Glob_Variable_Init.h"
...
void DisableInverter(void)
{
	...
	data_out.bit.led_inverter	= 0;			// Disable inverter LED
...
void EnableInverter(void)
{
	...
	data_out.bit.led_inverter	= 1;					// Enable inverter LED
}
