...
* Function: InitGpio()
*
* Description: Initialises the shared GPIO pins on the F2806x
**********************************************************************/
void InitGpio(void)
{
...
//--- Selected pin configurations
	GpioCtrlRegs.GPBDIR.bit.GPIO32 = 1;			// GPIO32 is an output (used for the LCD)
	GpioCtrlRegs.GPBDIR.bit.GPIO33 = 1;			// GPIO33 is an output	(used for the LCD)
	GpioCtrlRegs.GPADIR.bit.GPIO19 = 1;			// GPIO19 is an output	(used for the LCD)
	...
	GpioCtrlRegs.GPADIR.bit.GPIO16 = 0;			// GPIO16 is an input
